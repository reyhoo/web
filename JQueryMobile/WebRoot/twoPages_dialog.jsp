...
<html>
 ...
 <input type="hidden" id=app_path value="<%=path%>"> 
	<div data-role=page id=pageone>
		...
		<div data-role=content><p>page 1</p><a href="#pagetwo" data-rel=dialog>jump to page 2</a></div>
		<div data-role=footer><h1>页脚文本</h1></div>
	</div>
	<div data-role=page id=pagetwo>
		<div data-role=header><h6>欢迎访问我的主页</h6></div>
		<div data-role=content><p>page 2</p><a href=#pageone>jump to page 1</a></div>
		<div data-role=footer><h1>页脚文本</h1></div>
	</div>
  </body>
</html>
